...
class CityPlotter(tk.Tk):
    ...
    def __init__(self):
        ...
        self.end_entry.insert(0, '2022-01')


        # Create a button to plot the data and put it on its own row
        plot_button = ttk.Button(self, text='Plot Data', command=self.plot_data)
    ...
    def on_city_change(self, event):
        ...
        city = self.city_data[self.city_data['City'] == self.city_entry.get()].iloc[0]
        print(city)
        print(city['Latitude'])
